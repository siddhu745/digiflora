...
function NavBar() {
  ...
  const navItemCss = "my-auto tracking-wider hover:font-semibold hover:border-b-2 border-teal-500 cursor-pointer"
    ...
    >
      <div className="container mx-auto flex justify-between">
        ...
        <div className="flex gap-3 text-teal-500">
          ...
          <div className="text-white bg-teal-500 px-2 py-1 my-auto rounded-full cursor-pointer">Get Full Access</div>
        </div>
      </div>
    </div>
  );
